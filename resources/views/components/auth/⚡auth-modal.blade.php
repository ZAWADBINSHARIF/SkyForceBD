...
new class extends Component
{
    ...
    #[On('open-auth-modal')]
    public function open(string $mode = Modal::SIGNIN->value): void
    {
...
<div>
    ...
    <div class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
        <div
            class="relative w-full sm:max-w-md bg-white sm:rounded-2xl rounded-t-2xl shadow-2xl overflow-hidden max-h-[95dvh] overflow-y-auto">

            {{-- Close button --}}
            <button wire:click="close"
                class="absolute top-4 right-4 z-10 w-7 h-7 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
