    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative">
            <div class="rounded-2xl overflow-hidden aspect-[4/5] w-full max-w-md mx-auto lg:mx-0">
                <img src="{{ asset('images/about.jpeg') }}" alt="About Us"
        ...
        <div class="flex flex-col gap-5">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">
                ...
                <span class="text-primary-500">Shopping Experience</span>
            </h2>

            {{-- Body --}}
            <p class="text-gray-500 text-sm leading-relaxed">
                ShopLink is Bangladesh's fastest-growing e-commerce platform, built to bring quality products closer
                to you — wherever you are. From electronics and fashion to daily essentials, we source the best and
                deliver with care.
            </p>
