    ...
    <div
        ...
        <div class="flex items-center justify-around h-16 px-2">
            ...
            <a {{-- href="{{ route('order') }}" --}} wire:navigate
                ...
                <div
                    class="w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition-transform active:scale-90
                    {{ request()->routeIs('order') ? 'bg-primary-500 text-white' : 'bg-white border border-gray-100 text-primary-500' }}">
                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                    </svg>
                </div>
                <span class="text-[10px] font-bold mt-1
                    {{ request()->routeIs('order') ? 'text-primary-500' : 'text-gray-500' }}">
                    Request
                </span>
            </a>
