        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="px-8 py-10 text-center">
                ...
                <div class="flex flex-col gap-2.5">
                    <button wire:click="goOrders" type="button"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-red-600 leading-relaxed">
                                This can happen due to insufficient balance, incorrect card details, or a temporary
                                gateway issue. Please try again or use a different method.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-amber-700 leading-relaxed">
                                Your cart is still saved. You can go back and complete your purchase whenever you're
                                ready.
                            </p>
                        </div>
                    </div>
