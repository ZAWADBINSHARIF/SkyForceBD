        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <span class="text-lg text-gray-400 line-through mb-0.5">৳{{ number_format($product->old_price)
                        }}</span>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <img class="w-89" src="{{asset('images/sslcommerz-we-accept.png')}}"
                ...
                <a href="#"
                    ...
                    <div class="p-2.5">
                        ...
                        <div class="flex items-center gap-1.5 flex-wrap">
                            <span class="text-sm font-bold text-primary-500">৳{{ number_format($related->price)
                                }}</span>
                            @if($related->old_price)
                            <span class="text-[11px] text-gray-400 line-through">৳{{ number_format($related->old_price)
                                }}</span>
                            @endif
                        </div>
                    </div>
