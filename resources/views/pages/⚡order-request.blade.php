...
<div class="max-w-lg mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
    ...
    <div class="px-5 py-6">
        ...
        <div class="rounded-xl border border-gray-100 divide-y divide-gray-100 mb-4">
            <div class="px-4 py-3">
                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Send Payment To</p>
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <div class="w-7 h-7 rounded-lg bg-pink-50 flex items-center justify-center">
                                <span class="text-xs font-bold text-pink-600">bK</span>
                            </div>
                            <span class="text-sm font-medium text-gray-700">bKash</span>
                        </div>
                        <span class="text-sm font-semibold text-gray-800">01XXXXXXXXX</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <div class="w-7 h-7 rounded-lg bg-purple-50 flex items-center justify-center">
                                <span class="text-xs font-bold text-purple-600">N</span>
                            </div>
    ...
    <div class="px-5 pb-5 flex gap-3">
        ...
        <button wire:click="submitPayment" type="button"
